...
Unemp_filtered <- Unemp_OECD %>%
  filter(Location == "IRL" | Location == "FRA" | Location == "DEU" |
           Location == "ITA" | Location == "GBR" | Location =="ESP" |
           Location == "RUS" | Location == "USA" | Location == "CAN" |
           Location == "GRC" | Location == "NOR" | Location == "EU28" &
